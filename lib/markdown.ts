...
/**
 * Rough token estimate for the `x-markdown-tokens` header. Without shipping a
 * tokeniser, ~4 characters per token is the usual approximation for English
 * prose; it is advertised as a hint, not a guarantee.
 */
